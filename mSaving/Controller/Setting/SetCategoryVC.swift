...
extension SetCategoryVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = colorCollectionView.dequeueReusableCell(withReuseIdentifier: String(describing: IconCVCell.self), for: indexPath) as? IconCVCell else { return IconCVCell() }
