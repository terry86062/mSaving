...
extension SavingDetailVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == monthCollectionView {
            ...
            guard let cell = savingDetailCollectionView.dequeueReusableCell(withReuseIdentifier: String(describing: SavingCVCell.self), for: indexPath) as? SavingCVCell else { return SavingCVCell() }
...
extension SavingDetailVC: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if collectionView == monthCollectionView {
            ...
            return CGSize(width: savingDetailCollectionView.frame.width, height: savingDetailCollectionView.frame.height)
...
extension SavingDetailVC {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if scrollView.isEqual(monthCollectionView) {
            ...
            let row = Int((savingDetailCollectionView.bounds.origin.x + savingDetailCollectionView.frame.width / 2) / savingDetailCollectionView.frame.width)
            
            guard let cell = monthCollectionView.cellForItem(at: IndexPath(row: Int((savingDetailCollectionView.bounds.origin.x + savingDetailCollectionView.frame.width / 2) / savingDetailCollectionView.frame.width), section: 0)) as? MonthCVCell else { return }
            ...
            case 0:
                ...
                guard let cell3 = monthCollectionView.cellForItem(at: IndexPath(row: Int((savingDetailCollectionView.bounds.origin.x + savingDetailCollectionView.frame.width / 2) / savingDetailCollectionView.frame.width) + 1, section: 0)) as? MonthCVCell else { return }
            ...
            case testData.count:
                ...
                guard let cell2 = monthCollectionView.cellForItem(at: IndexPath(row: Int((savingDetailCollectionView.bounds.origin.x + savingDetailCollectionView.frame.width / 2) / savingDetailCollectionView.frame.width) - 1, section: 0)) as? MonthCVCell else { return }
