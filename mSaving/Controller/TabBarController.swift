...
//        button.setBackgroundImage(highlightImage, for: .highlighted)
        ...
        // two color view
        let twoColorView = UIView(frame: CGRect(x: 0, y: 0, width: (buttonImage.size.width / 2.0) + 1, height: (buttonImage.size.height / 2.0) + 1))
        let gradientLayer = CAGradientLayer()
        gradientLayer.frame = twoColorView.bounds
        gradientLayer.colors = [UIColor(red: 175 / 255, green: 175 / 255, blue: 175 / 255, alpha: 1).cgColor, UIColor(red: 175 / 255, green: 175 / 255, blue: 175 / 255, alpha: 1).cgColor, UIColor(red: 248 / 255, green: 248 / 255, blue: 248 / 255, alpha: 1).cgColor, UIColor(red: 248 / 255, green: 248 / 255, blue: 248 / 255, alpha: 1).cgColor]
        gradientLayer.locations = [NSNumber(value: 0.0), NSNumber(value: 0.3), NSNumber(value: 0.3), NSNumber(value: 1.0)]
