...
class AccountingTransformer {
    ...
    func transToAccountingsCategory(accountings: [Accounting]) -> [CategoryMonthTotal] {
            ...
            if index == 0 {
                ...
                if accounting.expenseCategory == preAccounting.expenseCategory &&
                    ...
                    categoriesMonthTotal.append(
                        CategoryMonthTotal(amount: accounting.amount,
                                           accountings: [[accounting]]))
    ...
    func sort(categoriesMonthTotal: [CategoryMonthTotal]) -> [CategoryMonthTotal] {
